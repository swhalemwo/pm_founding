...
As even with the broader single-digit Code 8, cultural spending constitutes the indicators with the least coverage (figure \textbf{X}), I furthermore combine as many data sources as possible (the exact combination procedure is described in Appendix \textbf{X}).
