...
\label{sec:orge4fc462}



\subsubsection*{Tax Incentives}
\label{sec:org1925147}


\label{sec:org7c651c1}
...
\label{sec:org7befeed}



\label{sec:orgba6889c}
...
\label{sec:org0e4daf3}
\paragraph*{Tax incentives}
\label{sec:org4a4211d}
...
\label{sec:org058dc03}
\paragraph*{GDP and Population size}
\label{sec:org5a5b089}
...
\subsection*{Results}
\label{sec:orge50bb0b}

\subsubsection*{Descriptive findings}
\label{sec:orge2d7bcb}
...
\label{sec:org82ad277}


\label{sec:orgf80086b}
...
\label{sec:org244340b}
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v91_cntrfctl.pdf}
