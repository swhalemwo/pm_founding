...
## ** v03-05: different versions of getting sqlite parallelism to work

## ** v06: mroe getting sqlite parallelism to work
vrbl_thld_choices_optmz <- slice_sample(vrbl_thld_choices, n=1)
...
## ** v07: more parallel writing debugging
vrbl_thld_choices_optmz <- slice_sample(vrbl_thld_choices, n=1)
...
## ** v30: test with diversity measures added
reg_settings_optmz <- list(
    ## relevant parameters
...
## ** v31: full surf run with diversity measures
reg_settings_optmz <- list(
    ## relevant parameters
