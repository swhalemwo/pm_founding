...
## define commands
cmd_reg            <- sprintf("Rscript regression.R %s >& %slog_reg.txt"     , PROJECT_DIR, LOG_DIR)
cmd_postestimation <- sprintf("Rscript postestimation.R %s >& %slog_post.txt", PROJECT_DIR, LOG_DIR)
cmd_anls           <- sprintf("Rscript reg_anls.R %s >& %slog_anls.txt"      , PROJECT_DIR, LOG_DIR)
cmd_finalize       <- sprintf("Rscript finalize.R %s >& %slog_finalize.txt"  , PROJECT_DIR, LOG_DIR)
