...
#+MACRO: ynkplt_oucoefchng_tile (eval (concat "#+label: fig:oucoefchng_tile\n" "#+caption: Coefficient changes given addition of other variables\n" "#+attr_latex: :width 24cm\n" "[[file:figures/plt_v75_oucoefchng_tile.pdf]]"))
#+MACRO: ynkplt_oucoefchng_cbn1 (eval (concat "#+label: fig:oucoefchng_cbn1\n" "#+caption: Coefficient changes given addition of other variables (DS all IVs)\n" "#+attr_latex: :width 14cm\n" "[[file:figures/plt_v75_oucoefchng_cbn1.pdf]]"))
#+MACRO: ynkplt_oucoefchng_cbn2 (eval (concat "#+label: fig:oucoefchng_cbn2\n" "#+caption: Coefficient changes given addition of other variables (DS --CuSp)\n" "#+attr_latex: :width 14cm\n" "[[file:figures/plt_v75_oucoefchng_cbn2.pdf]]"))
#+MACRO: ynkplt_oucoefchng_cbn3 (eval (concat "#+label: fig:oucoefchng_cbn3\n" "#+caption: Coefficient changes given addition of other variables (DS --CuSp/TMITR\n" "#+attr_latex: :width 14cm\n" "[[file:figures/plt_v75_oucoefchng_cbn3.pdf]]"))
