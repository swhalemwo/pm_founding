...
#+label: testtable
#+ATTR_LATEX: :caption "My Table Caption" :label "testtable"
#+INCLUDE: "./tables/testtable.tex" export latex

# #+latex: \end{table}

#+macro: rplt_cbn_cycnt \ref{fig:cbn_cycnt}

Table \ref{tbl:cbn_cpsgn} and figure {{{rplt_cbn_cycnt}}} shows the coverage of datasets by region, table [[testtable]] shows otherwise.
#
