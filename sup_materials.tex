...
\begin{filecontents}{refs_sup.bib}
\input{sup_materials.bib}
\end{filecontents}
\author{Johannes }
\date{\today}
\title{}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_vrbl_cycnt.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_cbn_cycnt.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_coef_violin.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_oneout_llrt_lldiff.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_oneout_llrt_z.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=24cm]{figures/plt_v34_oucoefchng.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_lag_dens.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{figures/plt_v34_vif.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=24cm]{figures/plt_v34_velp.pdf}
...
\bibliography{sup_materials.bib}
\end{document}
