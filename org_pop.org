...
#+MACRO: txdctblt_tmitr_interact_cbn2_exp 2.2
#+MACRO: tmitr_1SD_cbn_all 14.1
...
#
A 1 SD increase of the top marginal income tax rate ({{{tmitr_1SD_cbn_all}}} percentage points, corresponding approximately to the difference between the Netherlands ({{{tmitr_iso3c1}}}%) and Chile ({{{tmitr_iso3c2}}}%) in 2020) is associated with a difference in founding rate that is e\textsuperscript{{{{txdctblt_tmitr_interact_cbn2}}}} = {{{txdctblt_tmitr_interact_cbn2_exp}}} times larger in countries with tax deductibility of donations than in countries without.
# 
Given that the effect of an additional 1 SD top marginal income tax rate for countries without tax deductibility of donations is *-0.38*, a 1 SD increase in top marginal income tax rate in countries with tax deductibility of donations corresponds to an increase in founding rate by a factor of *-0.38 + 0.77*.
