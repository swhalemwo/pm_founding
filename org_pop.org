...
#
[[cite:&Boloten_Hacking_2021_foreword]]
#
A further pathway between low public funding and relatively high private museum founding concerns emerging art markets in developing countries, as it is argued that private collectors are more likely there to nurture a new art scene and/or satisfy public demand for art [[parencite:&Durand_2018_jumex;&Bechtler_Imhof_2018_future]].


# only temporal link
# While textcite:&Franklin_Papastergiadis_2017_anti also raise a relationship between declining acquisition budgets of public museums and private museum founding by arguing that the latter "became prominent once the price of contemporary art inflated beyond the means of most cash-strapped public museums to collect it systematically" (p.672), declining acquisition alone would presumably not raise a collector's likelihood of founding a private museum (
