...
This definition, in particular the focus on the private art collector as the primary founder, owner and *governor*, serves to investigate the phenomenon of personal projects of the people who decide to found them.
#
...
#
Even with the broader single-digit Code 8, cultural spending constitutes the indicators with the smallest coverage (figure {{{rplt_vrbl_cycnt}}}); I therefore combine as multiple data sources (the exact combination procedure is described in appendix \ref{app_data_processing}.
