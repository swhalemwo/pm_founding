...
#
Thus they also illustrate the highly skewed distribution of the variables, as predicted opening count at the means e.g. for "DS all IVs" with exp(-2.22)=0.10 is around one order of magnitude higher than average founding rate within the sample (0.011, table \ref{tbl:descs}).
