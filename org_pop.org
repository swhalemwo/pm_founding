...
#
Most country-years are situated between 2000 and 2020 with coverage generally increasing over time (figure {{{rplt_cbn_cycnt}}}); the datasets therefore effectively cover the period in which the majority of private museum founding has taken place (they cover {{{perc_opngs_cvrd_cbn1}}}, {{{perc_opngs_cvrd_cbn2}}} and {{{perc_opngs_cvrd_cbn3}}} of foundings, respectively). 
#
...
# 
This between-dataset variation in coefficient size could indicate mediation of GDP through cultural spending (cf. Appendix \ref{app_mediation} and {{{rplt_oucoefchng}}}); however further investigation would be required to more clearly determine the mechanism at play. 
...
#
Results are show in figure {{{rplt_cntrfctl}}} (the longitudinal changes of the predictor variables are shown in appendix \ref{app_velp}, {{{rplt_velp}}}).
#
