...
#
A 1 SD deviation increase of the top marginal income tax rate (14.1 percentage points) increases the effect of tax deductibility of donations by a factor of exp(0.75) = 2.117.
#
...
#
In particular, up to a value of 0.36/(2*0.64) = 0.28 (on the standardized government spending variable, which corresponds to cultural spending of 460 USD per capita, approximately the 2020 government cultural spending of Canada (452 USD) or Ireland (469 USD)) an increase in government spending corresponds to a higher predicted likelihood of private museum founding. 
#
Given the skewed distribution of cultural spending, 957 (76%) the country-years belong to this range of a positive association between government spending and private museum founding; this range also contains 63% of private museum foundings covered by "DS all IVs".
#
However above this range which (in 2020) includes countries prominent for their private museum populations such as Germany (560 USD), France (591 USD), the Nethelands (711 USD) or Switzerland (962 USD) increases in government spending are associated with lower rates of private museum founding (and conversely, decreases in government spending with higher rates of private museum founding).
# 
The data thus supports both the the crowding-out argument of the private museum literature of private museum founding as a consequence of declining government spending as well as the crowding in argument raised by philanthropy scholars. 
#
However, little evidence is found for lack of government spending facilitating private museum founding in emerging art market, as these are located in the region in which government spending is positively associated with private museum founding. 
