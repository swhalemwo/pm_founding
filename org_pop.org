...
#
In these two datasets, the coefficient of the HNWI population with a wealth larger than 5 million USD in particular is substantially negative and marginally significant ({{{hnwi_nbr_5M_cbn2_coef}}} (p = {{{hnwi_nbr_5M_cbn2_pvlu}}}) and {{{hnwi_nbr_5M_cbn3_coef}}} (p = {{{hnwi_nbr_5M_cbn3_pvlu}}}) for DS -CuSp and DS -CuSP/TMITR, respectively).
#
