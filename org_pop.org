...
The intercepts correspond to the predicted (logged) founding rate for a country-year with values of zero on all independent variables, which given the standardization of the variables, corresponds to a country at the means of the variables (and without tax deductibility of charitable donations).
#
...
#
A 1 SD increase of the top marginal income tax rate (14.1 percentage points) increases the effect of tax deductibility of donations by a factor of exp(0.75) = 2.117.
#
...
#
Thus overall the data indicates substantial support for an association between tax incentives and private museum founding (H1). 
