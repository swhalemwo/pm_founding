...
#
76 715 models are run, of which 76455 (99.7%) converge successfully. 
#
Given 36 variable combinations which are optimized five times with different starting values each per three datasets this results in an average of 142 regression models per variable combination.
...
#
Tax deductibility of donations are found to be positive and significant in "DS -CuSp/TMITR", indicating a exp(0.74) = 2.09 times higher rate of private museum founding in countries where charitable deductions are tax deductible.
#
