...
#
It is furthermore substantially larger in "DS --CuSp" ({{{gdp_coef_cbn2}}}) and "DS --CuSP/TMITR" ({{{gdp_coef_cbn3}}}) than in "DS all IVs" ({{{gdp_coef_cbn1}}}).
#
...
#
In these two datasets, the coefficient of the HNWI population with a wealth larger than 5 million USD in particular is substantially negative ({{{hnwi_nbr_5M_cbn2_coef}}} and {{{hnwi_nbr_5M_cbn3_coef}}}) and marginally significant (p = {{{hnwi_nbr_5M_cbn2_pvlu}}} and p = {{{hnwi_nbr_5M_cbn3_pvlu}}} for DS -CuSp and DS -CuSP/TMITR, respectively).
#
