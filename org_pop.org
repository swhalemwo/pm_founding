...
# 
This between-dataset variation in coefficient size could indicate mediation of GDP through cultural spending *(cf Appendix and {{{rplt_oucoefchng}}})*; however further investigation would be required to more clearly determine the mechanism at play. 
...
#
A positive role of tax incentives is further supported by the positive and marginally significant (p = {{{Ind_tax_incentives_cbn3_pvlu}}}) coefficient of tax deductibility of donations in "DS --CuSp/TMITR", indicating that countries with tax deductibility of donations see $e$^{{{{Ind_tax_incentives_cbn3_coef}}}} = {{{Ind_tax_incentives_cbn3_coef_exp}}} times more private museum founding than countries without. 
...
#
In particular, up to a value of {{{smorc_lin_flipped}}}/(2*{{{smorc_sqrd}}}) = {{{smorc_top_point_std}}} (corresponding to cultural spending of {{{smorc_top_point}}} USD per capita, approximately the 2020 government cultural spending of Slovakia ({{{smorc_2020_SVK}}} USD) or New Zealand ({{{smorc_2020_NZL}}} USD)) an increase in government spending corresponds to a higher predicted likelihood of private museum founding. 
#
