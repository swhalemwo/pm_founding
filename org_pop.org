...
#+INCLUDE: "./tables/tbl:regrslts_wcptblF_v91.tex" export latex
...
#+INCLUDE: "./tables/tbl:cbn_cpsgn_v91.tex" export latex
...
#+INCLUDE: "./tables/tbl:descs_v91.tex" export latex
#+latex: \end{landscape}
