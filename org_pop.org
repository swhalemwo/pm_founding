...
#
In particular, up to a value of 0.36/(2*0.64) = 0.28 (on the standardized government spending variable, which corresponds to cultural spending of 432 USD per capita, approximately the 2020 government cultural spending of Slovakia (415 USD), the United Arab Emirates (440 USD) or New Zealand (469 USD)) an increase in government spending corresponds to a higher predicted likelihood of private museum founding. 
#
This range of a positive association between government spending and private museum founding consists of 815 (65%) of the country-years belong of "DS all IVs"; it also contains 59% of covered private museum foundings.
#
It is furthermore worth to consider that "DS all IVs" consists disproportionately of wealthy countries, the true proportion of country-years in which higher government expenditure is associated with higher private museum is presumably even higher.
#
Nevertheless, in the range above this turning point which (in 2020) includes countries prominent for their private museum populations such as Germany (560 USD), France (591 USD), the Nethelands (711 USD) or Switzerland (962 USD) increases in government spending are associated with lower rates of private museum founding (and conversely, decreases in government spending with higher rates of private museum founding).
# 
