...
#
For example, a 1 SD increase of the wealth share of the top 10% (7.6% in 2020 in "DS all IVs", which corresponds approximately to the difference between Denmark (50.2%) and the Czech Republic (57.9)) corresponds to an increase in private museum founding rate by a factor of exp(0.28) = 1.32.
#
