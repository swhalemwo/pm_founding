...
#
A 1 SD increase of the top marginal income tax rate ({{{tmitr_1SD_cbn_no_cult_spending}}} percentage points, corresponding approximately to the difference between the Netherlands ({{{tmitr_iso3c1}}}%) and Chile ({{{tmitr_iso3c2}}}%) in 2020) is associated with a difference in founding rate that is e\textsuperscript{{{{txdctblt_tmitr_interact_cbn2}}}} = {{{txdctblt_tmitr_interact_cbn2_exp}}} times larger in countries with tax deductibility of donations than in countries without. e\textsuperscript{{{{opng_p1m_glbl_yearly_cbn_no_cult_spending_and_mitr}}}} e^{{{{opng_p1m_glbl_yearly_cbn_no_cult_spending_and_mitr}}}} $e$^{{{{opng_p1m_glbl_yearly_cbn_no_cult_spending_and_mitr}}}}
# 
